...
export SCOPTS_ROMsh="-e SC2155 -e SC2120 -e SC2119 -e SC2086 -e SC2046 -e SC2153 -e SC2016 -e SC2030 -e SC2031 -e SC2162 -e SC2164 -e SC1090";
# Flags to be disabled on ROM.rc
export SCOPTS_ROMrc="-e SC2034 -e SC2153 -e SC2154";
# Flags to be disabled on upScriBt.sh
export SCOPTS_upScriBtsh="-e SC1083 -e SC2086";
...
for file in ROM.sh ROM.rc upScriBt.sh; do
    ...
    shellcheck --shell=bash ${OPTS} "$file";
    derpcheck "$file";
    (( NO++ ));
done
